            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [Colors.orange[200], Colors.red],
                ),
              ),
            ),
          ),
      ...
      child: Row(
        ...
        children: <Widget>[
          Text(
            ...
            style: TextStyle(
              fontWeight: FontWeight.w200,fontSize: _large? 20 : (_medium? 17.5 : 15),
            ),
          ),
        ],
      ),
    ...
    return RaisedButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[Colors.orange[200], Colors.red],
          ),
        ),
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "Sign up",
              style: TextStyle(
                  fontWeight: FontWeight.w800, color: Colors.red[200], fontSize: _large? 19: (_medium? 17: 15)),
            ),
          )
        ],
      ),
